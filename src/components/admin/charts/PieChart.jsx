  ...
  const fetchData = async () => {
    try {
      const [maleResponse, femaleResponse] = await Promise.all([
        axiosInstance.get("/staffmember/maleEmployees"),
        axiosInstance.get("/staffmember/femaleEmployees"),
      ]);
      ...
      setData([
        { id: "Male", label: "Male", value: maleCount, color: "#1674BB" },
        { id: "Female", label: "Female", value: femaleCount, color: "#868FA0" },
      ]);
    } catch (error) {
