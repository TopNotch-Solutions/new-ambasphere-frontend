...
const ControlCards = () => {
  ...
  const confirmUploadCollectionProof = async () => {
    ...
    try {
      const response = await axiosInstance.post(`/handsets/upload-collection-proof/${selectedHandset.id}`, {
        uploadedBy: currentUser.FullName,
        collectionDate: collectionDate,
        collectedBy: collectedBy || currentUser.FullName
      });
            ...
            <Box mb={2}>
              <Alert severity="info" sx={{ mb: 2 }}>
                <Typography variant="body2">
                  ...
                  <strong>MR Number:</strong> {selectedHandset.MRNumber}
                </Typography>
              </Alert>
              ...
              <Alert severity="warning" sx={{ mt: 2 }}>
                <Typography variant="body2">
                  ...
                  Make sure the signed control card and pickup list are properly uploaded to the ERP system.
                </Typography>
              </Alert>
            </Box>
          )}
